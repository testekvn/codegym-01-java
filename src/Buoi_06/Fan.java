...
public class Fan {
    ...
    public void fanStatus(boolean hasOn) {
        if (!hasOn) {
        ...
        // Cach 1
        String curStatus = "on";
        if (!hasOn) curStatus = "Off";
        System.out.println("Fan is " + curStatus);

        // Cach 2
        String currentStatus = hasOn ? "On" : "Off";
        System.out.println("Fan is " + currentStatus);
    }
}
